 ...
 * @author AGUSTIN
 */
public class Vent1_2 extends javax.swing.JFrame {

    /**
     * Creates new form vent2_2
     */
    public Vent1_2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vent1_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
